...
<!--(10 Feb 2022) QH: Just putting all of the code and writing here. Not going to worry about formatting for now -->
<!--(10 Feb 2022) QH: On a secondary note, I managed to cause an error with docker in record time. We will need to fix that later-->
<!--(10 Feb 2022) QH: Lastly, I'm going to do my best to get the code working tonight. If that fails, I will still write up my interpretation using prior images of the visualization-->
...
<!--(11 Feb 2022) QH: Currently it is 1:20 AM. I have been fiddling about with code and github for awhile. I plan on fixing everything when I wake up, and, failing that, Friday afternoon.-->
```{r}
ma_flakes_tr_with_groups <-
 ...
 #QH here, not sure what this is doing for now, just putting it off to the side: mutate(mass_group = as.factor(test_result_mass$cluster))
# plot mass groups
