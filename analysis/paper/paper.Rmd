...
# Note, trying to fix NA by removing all rows which lack dorsal cortex values. Issue with the intial set of data with NA values being passed through PCA. In the process of fixing
...
ma_flakes_tr_with_groups <-
  ...
  mutate(dorsal_cortext_group =
           case_when(
             ...
             between(dorsal_cortex_perc, 1, 60) ~ "Secondary",
...
Papageorgiou, I. (2020). Ceramic investigation: How to perform statistical analyses. Archaeological and Anthropological Sciences, 12(9), 210. https://doi.org/10.1007/s12520-020-01142-x
