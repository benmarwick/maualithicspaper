...
```
  ...
  <!-- Could not figure out how to change the labels on the x axis for the two bar charts, so I included a small table with the human-meaningful values for now-->
